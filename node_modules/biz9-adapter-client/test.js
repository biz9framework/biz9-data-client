...
import { get_new_item,get_data_config,get_cloud_url  }  from './';
/* --- TEST CONFIG START --- */
//const ID='0';
...
describe("connect", () => {
    it("_connect", () => {
        series([
            function(call) {
                console.log('TEST-BIZ9-ADAPTER-CLIENT-CONNECT-START');
                call();
            },
            function(call) {
                console.log('TEST-BIZ9-ADAPTER-CLIENT-GET-NEW-ITEM-START');
                var _new_item = get_new_item(DATA_TYPE,0);
                console.log(_new_item);
                console.log('TEST-BIZ9-ADAPTER-CLIENT-GET-NEW-ITEM-SUCCESS');
                call();
            },
            function(call) {
                console.log('TEST-BIZ9-ADAPTER-CLIENT-GET-DATA-CONFIG-START');
                var _data_config = get_data_config(biz9_config,{app_title_id:'local_app_title_id'});
                console.log(_data_config);
                console.log('TEST-BIZ9-ADAPTER-CLIENT-GET-DATA-CONFIG-SUCCESS');
                call();
            },
            function(call) {
                console.log('TEST-BIZ9-ADAPTER-CLIENT-GET-CLOUD-URL-START');
                var _cloud_url = get_cloud_url(biz9_config.APP_TITLE_ID,CLOUD_URL,'/get/test/');
                console.log(_cloud_url);
                console.log('TEST-BIZ9-ADAPTER-CLIENT-GET-CLOUD-URL-SUCCESS');
                call();
            },

        ], function(err, results) {
            console.log('TEST-BIZ9-ADAPTER-CLIENT-CONNECT-SUCCESS');
            console.log('TEST-BIZ9-ADAPTER-CLIENT-GET-DATA-CONFIG-SUCCESS');
            console.log('TEST-BIZ9-ADAPTER-CLIENT-GET-NEW-ITEM-SUCCESS');
            console.log('TEST-BIZ9-ADAPTER-CLIENT-GET-CLOUD-URL-SUCCESS');
            console.log('TEST-BIZ9-ADAPTER-CLIENT-CONNECT-DONE');
